...
void AiEnemy()
{
	...
	if ((Enemy.g_sEnemy.m_cLocation.X > 0 && g_sChar.m_cLocation.X - Enemy.g_sEnemy.m_cLocation.X > 0)	//Detect Right  //Lesser than 0 
		&& (g_sChar.m_cLocation.Y == Enemy.g_sEnemy.m_cLocation.Y)												//Greater than -5
		&& (g_sChar.m_cLocation.X - Enemy.g_sEnemy.m_cLocation.X <= 5))											// -5 < x < 0
	{
		Detect = true;
	}
	if ((g_sChar.m_cLocation.X > 0 && g_sChar.m_cLocation.X - Enemy.g_sEnemy.m_cLocation.X < 0) //Detect Left
		&& (g_sChar.m_cLocation.Y == Enemy.g_sEnemy.m_cLocation.Y)
		&& (g_sChar.m_cLocation.X - Enemy.g_sEnemy.m_cLocation.X >= -5))
	{
		Detect = true;
	}
	if ((g_sChar.m_cLocation.Y > 0 && g_sChar.m_cLocation.Y - Enemy.g_sEnemy.m_cLocation.Y > 0) // Detect Down
		&& (g_sChar.m_cLocation.X == Enemy.g_sEnemy.m_cLocation.X)
		&& (g_sChar.m_cLocation.Y - Enemy.g_sEnemy.m_cLocation.Y <= 5))
	{
		Detect = true;
	}
	if ((g_sChar.m_cLocation.Y > 0 && g_sChar.m_cLocation.Y - Enemy.g_sEnemy.m_cLocation.Y < 0) //Detect Up
		&& (g_sChar.m_cLocation.X == Enemy.g_sEnemy.m_cLocation.X)
		&& (g_sChar.m_cLocation.Y - Enemy.g_sEnemy.m_cLocation.Y >= -5))
	{
		Detect = true;
	...
	if ((Enemy.g_sEnemy.m_cLocation.X == g_sChar.m_cLocation.X) && (Enemy.g_sEnemy.m_cLocation.Y == g_sChar.m_cLocation.Y)
		&& encounterCheck1 == 0)
	{
		encounter = true;
		encounterCheck1 = 1;
...
void renderEnemy()
{
	...
	g_Console.writeToBuffer(Enemy.g_sEnemy.m_cLocation, (char)97, charColor);
